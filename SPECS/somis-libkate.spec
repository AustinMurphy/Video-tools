...
%doc %{_docdir}/somis-libkate-%{version}
%{_libdir}/*.so.*
%exclude %{_docdir}/somis-libkate-%{version}/html
...
%files docs
%defattr(-, root, root, 0755)
%doc %{_docdir}/somis-libkate-%{version}/html
